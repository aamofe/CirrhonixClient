  ...
  <div class="authors-page">
    <section class="page-header">
      ...
      <div class="search-container">
        <input type="text" v-model="searchQuery" placeholder="搜索专家姓名或所属机构..." @input="debounceSearch" />
      ...
      <div class="filter-section">
        <div class="filter-group">
          ...
          <div class="sort-options">
            <span :class="{ active: sortBy === 'name' }" @click="setSortBy('name')">按姓名</span>
            <span :class="{ active: sortBy === 'publications' }" @click="setSortBy('publications')">按发表数量</span>
          </div>
        </div>
      </div>
